...
export interface ExperienceSliceDefaultPrimaryExpItemItem {
  /**
   * Title field in *Experience → Default → Primary → Exp Item*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp_item[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
  ...
  /**
   * Institution field in *Experience → Default → Primary → Exp Item*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp_item[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Button Text field in *Experience → Default → Primary → Exp Item*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp_item[].button_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_text: prismic.KeyTextField;

  /**
   * Button Link field in *Experience → Default → Primary → Exp Item*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp_item[].button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_link: prismic.LinkField;
}
